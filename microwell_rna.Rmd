...
```{r}
scrna.data <- Read10X("~/filtered_gene_bc_matrices/")
Hash_microwell_cells <- scan("~/Hash-Hash-seq_4230_cells.csv", character(), quote = "")
Hash_matrigel_cells <- scan("~/Hash-Hash-seq_4230_WT_Hash_cells.csv", character(), quote = "")
